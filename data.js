...
window.PATHWAY = {
  ...
  resourceMap: {
    ...
    sub:
      "Each resource plays a different role. BibleProject supplies the biblical theology behind a practice (the why, rooted in the whole Bible story); Practicing the Way supplies the how-to; Foundations is our adaptable scaffold. This is a first read for the teachers reviewing resources — expect it to change.",
    columns: ["Practice", "BibleProject — theology / why", "Practicing the Way — the practice", "Foundations — our scaffold"],
    rows: [
    ...
    note:
      "Practicing the Way also covers Sabbath, Solitude, and Fasting — the classic practices our brief flags for review. BibleProject's Sabbath theme video pairs naturally with the first of these. Empty cells (—) mark where no resource currently speaks to a practice — useful for spotting where leaders may need to develop material."
  },
